...
import { Box, Paper, Typography, Card, CardContent, CardMedia, Divider } from '@mui/material'
...
const ContactVisitorComp = ({ isMobile }) => {
    return (
        <>
            <Box mx="auto" my="auto" component={Paper} backgroundColor="#BA9775" borderRadius={3} sx={{
                display: 'flex',
                ...
                <Box width={ isMobile? '90%' : '45%'} pt={5} pl={isMobile? 3: 0}>
                        ...
                        >
                            ...
                            <CardContent sx={{ width: isMobile ? '100%' : '65%' }}>
                                ...
                                <Box textAlign="end" mr={3} display={'flex'} justifyContent={isMobile ? 'center' : 'flex-end'} alignItems="center">
                                    <Box sx={{ cursor: 'pointer' }} width={isMobile ? '55%' : '30%'} display="flex" alignItems="center" justifyContent="space-around" mt={2} backgroundColor="#fff" px={1}>
                                        <CustomButton
                    ...
                    <Box my={2}  display={'flex'} alignItems={'center'} gap={isMobile? 2: 5}>
                        <Divider sx={{ backgroundColor: '#fff', width: isMobile? '50%':'70%', height: '1px' }} />
                        <Box variant='button' sx={{ cursor: 'pointer' }}>
                            <Image src="/Group 115.png" width={100} height={50} alt="Button Icon" />
                        </Box>
                    </Box>
                </Box>
            </Box>
