      ...
      <Grid p={4} mt={4} container>
        <Grid item xs={12} md={8}>
          ...
          >
            ...
            <Box p={5}>
              ...
              >
                ...
                ABV. Required to be aged in oak at least 2 years. Also, if
            ...
            >
              <Box width={isMobile ? "100%" : "70%"}>
                ...
                <Typography textAlign={"left"} variant="body1" gutterBottom>
                  ...
                  marketing description and perhaps in discord with the line’s
                  name, “Eleganse,” the palate is bold and rich with a pleasant
                  impression of grippy oak tannin. Although perhaps slightly
                  misnamed, this would be a wonderful cognac for whisky lovers
                  and its concentration of wood and fruit flavors would make for
                  great New Orleans style cocktails."
                </Typography>
              </Box>
              <Box p={4}>
          ...
          <Box
            ...
            borderRadius={5}
            p={isMobile ? 2 : 3}
            sx={{ backgroundImage: 'url("/Rectangle 53.png")', color: "#FFF" }}
          >
