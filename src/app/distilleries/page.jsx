  ...
  return (
    <Box>
      ...
      <Box mx="auto" my="auto" sx={{
        ...
        <Box width={isMobile? '100%': '60%'} component={Paper} backgroundColor="#222" borderRadius={2} >
      ...
      <Modal open={openModal} onClose={handleCloseModal}>
        ...
        >
          ...
          <DistelleryModalForm handleCloseModal={handleCloseModal} isMobile={isMobile} />
